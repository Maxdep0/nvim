    ...
    config = function()
        ...
        require('gitsigns').setup({
            ...
            on_attach = function(bufnr)
                ...
                map({'n', 'v'}, 'hs', ':Gitsigns stage_hunk<CR>',                    { desc = 'Git: [H]unt [S]tage for commit' })
                map({'n', 'v'}, 'hR', ':Gitsigns reset_hunk<CR>',                    { desc = 'Git: [H]unt [R]eset to the state in HEAD commit' })
                map('n',        'hS', gs.stage_buffer,                               { desc = 'Git: [H]unt [S]tage entire file' })
                ...
                map('n',        'tp', gs.preview_hunk,                               { desc = 'Git: [T]oggle [D]elete preview window showing current hunk' })
                map('n',        'td', gs.toggle_deleted,                             { desc = 'Git: [T]oggle [D]iff view of deleted lines in current file' })
